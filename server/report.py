...
def create_recurring_chain(vectorStore):
    ...
    ("user", (
        "Assume the position of a mental health professional and Answer the user's questions based on the context.Make the answer short"
        
        "Given the mental health situation of the patient, your task is to:\n"
        ...
        "Then, start the first identified cognitive distortion on a new line, followed by a colon and an explanation in one or two "
        "sentences.\n"
        
        "Start the second identified cognitive distortion on a new line as well, followed by a colon and an explanation in one or two" 
        "sentences.\n"
